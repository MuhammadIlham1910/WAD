...
<title>
    Esport Tournamen</title>
<body>
    <nav class="navbar navbar-dark bg-dark">
            <span class="navbar-brand mb-0 h1">Selamat Datang Di Pendaftaran Tournamen Mobile Legend Antar SMA/SMK</span>
        </div>
    </nav>
<div class="container">
    <br>
    <h4><center>DAFTAR SQUAD TOURNAMEN MOBILE LEGEND</center></h4>
<?php
